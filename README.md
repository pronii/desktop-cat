...
```text
dist/desktop-cat-0.3.15-win-x64-setup.exe
dist/desktop-cat-0.3.15-win-x64-portable.exe
```
...
{
  "version": "0.3.15",
  "url": "https://example.com/releases/desktop-cat-0.3.15.exe",
