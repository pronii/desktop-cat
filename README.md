...
```text
dist/desktop-cat-0.3.12-win-x64-setup.exe
dist/desktop-cat-0.3.12-win-x64-portable.exe
```
...
{
  "version": "0.3.12",
  "url": "https://example.com/releases/desktop-cat-0.3.12.exe",
