...
```text
dist/desktop-cat-0.3.13-win-x64-setup.exe
dist/desktop-cat-0.3.13-win-x64-portable.exe
```
...
{
  "version": "0.3.13",
  "url": "https://example.com/releases/desktop-cat-0.3.13.exe",
