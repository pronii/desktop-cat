...
```text
dist/desktop-cat-0.3.3-win-x64-setup.exe
dist/desktop-cat-0.3.3-win-x64-portable.exe
```
...
{
  "version": "0.3.3",
  "url": "https://example.com/releases/desktop-cat-0.3.3.exe",
